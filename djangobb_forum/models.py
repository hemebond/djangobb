...
class Post(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='posts', verbose_name=_('User'), blank=True, null=True, on_delete=models.SET_NULL)
    created = models.DateTimeField(_('Created'), auto_now_add=True)
    updated = models.DateTimeField(_('Updated'), blank=True, null=True)
    updated_by = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Updated by'), blank=True, null=True, on_delete=models.SET_NULL)
...
class Reputation(models.Model):
    from_user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='reputations_from', verbose_name=_('From'), blank=True, null=True, on_delete=models.SET_NULL)
    to_user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='reputations_to', verbose_name=_('To'), blank=True, null=True, on_delete=models.SET_NULL)
    post = models.ForeignKey(Post, related_name='post', verbose_name=_('Post'), blank=True, null=True, on_delete=models.SET_NULL)
...
class Profile(models.Model):
    ...
    language = models.CharField(_('Language'), max_length=7, default='', choices=settings.LANGUAGES)
...
class Report(models.Model):
    ...
    zapped_by = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='zapped_by', blank=True, null=True, verbose_name=_('Zapped by'), on_delete=models.SET_NULL)
...
class Ban(models.Model):
    user = models.OneToOneField(settings.AUTH_USER_MODEL, verbose_name=_('Banned user'), related_name='ban_users', blank=True, null=True, on_delete=models.SET_NULL)
